...
***developed by:RASSHMIKA PD***
***register number:212224060211***
***program***
import random

class VacuumCleanerAgent:
    def _init_(self):  # Initialize the agent's state (location and dirt status)
...
agent.print_status()
***output***
<img width="727" height="164" alt="image" src="https://github.com/user-attachments/assets/a2be4540-2f35-49a2-adcd-6b11e706826e" />
***result***
The PEAS framework helps in systematically designing AI agents by defining performance measures, environment, actuators, and sensors. It ensures clarity, efficiency, and adaptability in developing agents for real-world application
